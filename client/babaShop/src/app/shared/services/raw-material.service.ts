...
export class RawMaterialService {
  ...
  getSummary(): Observable<any> {
    return this.http.get(`${this.baseURL}/api/raw-materials/summary`);
  }
  ...
  updateMaterial(id: string, payload: any): Observable<any> {
    return this.http.put(`${this.baseURL}/api/raw-materials/${id}`, payload);
  }

  deleteMaterial(id: string): Observable<any> {
    return this.http.delete(`${this.baseURL}/api/raw-materials/${id}`);
  }
}
