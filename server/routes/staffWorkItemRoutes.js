...
router.post("/", authorizeRoles("SUPER_ADMIN", "ADMIN", "MANAGER"), authorizeFeature("staff.daily_work"), staffWorkItemController.createStaffWorkItem);
router.put("/:id", authorizeRoles("SUPER_ADMIN", "ADMIN", "MANAGER"), authorizeFeature("staff.daily_work"), staffWorkItemController.updateStaffWorkItem);
router.delete("/:id", authorizeRoles("SUPER_ADMIN", "ADMIN", "MANAGER"), authorizeFeature("staff.daily_work"), staffWorkItemController.deleteStaffWorkItem);
